...
ST_PIS_CALCULA = (
    ST_PIS_TRIB_NORMAL,
    ST_PIS_TRIB_DIFERENCIADA,
    ST_PIS_TRIB_QUANTIDADE,
    ST_PIS_OUTRAS,
    ST_PIS_OUTRAS_SAIDA,
)
...
ST_COFINS_OUTRAS = '99'
ST_COFINS_CALCULA = (
    ST_COFINS_TRIB_NORMAL,
    ST_COFINS_TRIB_DIFERENCIADA,
    ST_COFINS_TRIB_QUANTIDADE,
    ST_COFINS_OUTRAS,
    ST_COFINS_OUTRAS_SAIDA,
)
...
TIPO_RODADO_DIC = dict(TIPO_RODADO)

TIPO_RODADO_TRUCK = '01'
TIPO_RODADO_TOCO = '02'
TIPO_RODADO_CAVALO_MECANICO = '03'
TIPO_RODADO_VAN = '04'
TIPO_RODADO_UTILITARIO = '05'
TIPO_RODADO_OUTROS = '06'

CODIGO_UNIDADE_MEDIDA_PESO_BRUTO_CARGA = (
    ('01', 'KG'),
    ('02', 'TON'),
)

CODIGO_UNIDADE_MEDIDA_PESO_BRUTO_CARGA_DIC = dict(CODIGO_UNIDADE_MEDIDA_PESO_BRUTO_CARGA)

CODIGO_UNIDADE_MEDIDA_PESO_BRUTO_CARGA_KG = '01'
CODIGO_UNIDADE_MEDIDA_PESO_BRUTO_CARGA_TON = '02'
...
TIPO_TRANSPORTADOR_DICT = dict(TIPO_TRANSPORTADOR)

TIPO_TRANSPORTADOR_ETC = '1'
TIPO_TRANSPORTADOR_TAC = '2'
TIPO_TRANSPORTADOR_CTC = '3'
...
MODALIDADE_TRANSPORTE_DICT = dict(MODALIDADE_TRANSPORTE)

MODALIDADE_TRANSPORTE_RODOVIARIO = '1'
MODALIDADE_TRANSPORTE_AEREO = '2'
MODALIDADE_TRANSPORTE_AQUAVIARIO = '3'
MODALIDADE_TRANSPORTE_FERROVIARIO = '4'
...
TIPO_UNIDADE_CARGA_DICT = dict(TIPO_UNIDADE_CARGA)

TIPO_UNIDADE_CARGA_CONTAINER = '1'
TIPO_UNIDADE_CARGA_ULD = '2'
TIPO_UNIDADE_CARGA_PALLET = '3'
TIPO_UNIDADE_CARGA_OUTROS = '4'
...
TIPO_NAVEGACAO_DICT = dict(TIPO_NAVEGACAO)

TIPO_NAVEGACAO_INTERIOR = '0'
TIPO_NAVEGACAO_CABOTAGEM = '1'

TIPO_UNIDADE_TRANSPORTE_VAZIA = (
    ('1', 'Rodoviario Tracao Tipo Caminhao'),
    ('2', 'Rodoviario Reboque Tipo Carreta'),
)

TIPO_UNIDADE_TRANSPORTE_VAZIA_DICT = dict(TIPO_UNIDADE_TRANSPORTE_VAZIA)

TIPO_UNIDADE_TRANSPORTE_VAZIA_CAMINHAO = '1'
TIPO_UNIDADE_TRANSPORTE_VAZIA_CARRETA = '2'

TIPO_EMITENTE = (
    ('1', 'Prestador de serviço de transporte.'),
    ('2', 'Transpotador de Carga Própria.'),
)

TIPO_EMITENTE_DIC = dict(TIPO_EMITENTE)

TIPO_EMITENTE_PRESTADOR_SERVICO = 1
TIPO_EMITENTE_PROPRIO = 2
