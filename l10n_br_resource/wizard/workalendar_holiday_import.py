    ...
    def holiday_import(self):
        ...
        for wiz in self:
            ...
            public_holidays = [
                ...
                for holiday in feriado.FERIADOS
                if holiday.data() <= fields.Date.from_string(wiz.end_date)]
                # holiday.data() >= fields.Date.from_string(wiz.start_date)
            for holiday in public_holidays:
                utc_dt = fields.Datetime.from_string(
                    fields.Datetime.to_string(holiday.data()))
